...
# Page configuration
configure_page(page_title="Holder Distribution Analytics", page_icon="📊")
...
def main():
    ...
    # Sidebar summary
    sidebar_analysis_summary({
        "Gini Coefficient": f"{metrics['gini']:.4f}",
        "Top 10 Hold": f"{metrics['top_10_pct']:.1f}%",
        "Whales": tiers["whales"],
        "Total Holders": f"{tiers['total']:,}",
    })
